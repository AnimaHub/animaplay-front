...
const InputImg = () => {
    ...
    ;(function () {
        ...
        function leEAtualiza() {
            ...
            console.log("Cima ", imagemEnviada);
            ...
            leitorDeArquivos.addEventListener('loadend', function (load) {
                ...
                console.log("Baixo ", load.target.result);
    ...
    return (
        <div>
            <form className="upload-imagem">
                <input type="file" className="upload" required/>
                <button>Alterar Imagem</button>
            </form>

            <div>
                <img className="imagem" src="http://via.placeholder.com/350x150" alt="Sua imagem" width="350"
                     height="150"/>
            </div>

            <h2>ou direto neste botao após enviar uma imagem!!</h2>
            <div>
                <button className="btnAtualiza">Atualiza imagem</button>
            </div>
        </div>
    )
}
